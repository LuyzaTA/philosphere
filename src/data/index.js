export const philosophers = [
  ...
  },
  {
    ...
    ideas: ['being', 'self', 'truth', 'language', 'nature'],
    influences: ['zhuangzi'],
    influencedBy: [],
    color: '#FF8C42'
  },
  {
    ...
    ideas: ['self', 'being', 'freedom', 'truth', 'nature'],
    influences: [],
    influencedBy: ['laozi'],
    color: '#FF8C42'
  },
  ...
  },
  {
    ...
    ideas: ['god', 'freedom', 'being', 'good', 'nature'],
    influences: ['chaui'],
  ...
  },
  {
    ...
    influences: ['foucault', 'djamila-ribeiro'],
  ...
  },
  {
    ...
    ideas: ['justice', 'freedom', 'good', 'power', 'nature'],
    influences: [],
  ...
  // ── Eastern (additions) ─────────────────────────────────────────────────────
  {
    ...
    born: -563, died: -483,
    location: { lat: 27.47, lng: 83.28, city: 'Lumbini', country: 'Nepal' },
    era: 'ancient-india',
    tradition: 'Buddhist',
    quote: 'All that we are is the result of what we have thought.',
    concept: 'Suffering is born of craving; the self we defend so fiercely is a bundle of processes with no fixed core (anattā).',
    ideas: ['self', 'being', 'consciousness', 'good'],
    influences: ['nagarjuna', 'dogen', 'ambedkar'],
    influencedBy: [],
    color: '#FFC857'
  },
  {
    ...
    name: 'Mozi',
    born: -470, died: -391,
    location: { lat: 35.10, lng: 117.15, city: 'Teng', country: 'China' },
    era: 'ancient-east',
    tradition: 'East Asian',
    quote: 'When everyone regards the states of others as they regard their own, who then would incite their state to attack that of another?',
    concept: 'Impartial care for all (jian ai) — judge every act by whether it benefits everyone alike, not just your own kin.',
    ideas: ['good', 'justice', 'virtue'],
    influences: [],
    influencedBy: [],
    color: '#FF8C42'
  },
  {
    ...
    name: 'Xunzi',
    born: -310, died: -235,
    location: { lat: 37.75, lng: 114.50, city: 'Zhao', country: 'China' },
    era: 'ancient-east',
    tradition: 'East Asian',
    quote: 'The nature of man is evil; his goodness is acquired.',
    concept: 'Human nature tends toward the crooked; ritual, teachers, and learning — not instinct — are what straighten us into goodness.',
    ideas: ['self', 'good', 'virtue', 'knowledge'],
    influences: ['hanfeizi'],
    influencedBy: ['confucius'],
    color: '#FF8C42'
  },
  {
    ...
    name: 'Han Feizi',
    born: -280, died: -233,
    location: { lat: 34.28, lng: 113.75, city: 'Han', country: 'China' },
    era: 'ancient-east',
    tradition: 'East Asian',
    quote: 'When the state is well governed, the people are secure; when it is ill governed, they are in peril.',
    concept: 'Order comes from clear law and the calibrated use of power, not from trusting the private virtue of rulers.',
    ideas: ['power', 'justice', 'self'],
    influences: [],
    influencedBy: ['xunzi'],
    color: '#FF8C42'
  },
  {
    ...
    name: 'Wang Yangming',
    born: 1472, died: 1529,
    location: { lat: 30.04, lng: 121.15, city: 'Yuyao', country: 'China' },
    era: 'neo-confucian',
    tradition: 'East Asian',
    quote: 'Knowledge is the beginning of action; action is the completion of knowledge.',
    concept: 'Knowing and doing are a single act — the innate moral knowing (liangzhi) is already within you, waiting to be enacted.',
    ideas: ['knowledge', 'virtue', 'self', 'good'],
    influences: [],
    influencedBy: ['mencius', 'zhu-xi'],
    color: '#FF8C42'
  },
  {
    id: 'ramanuja',
    name: 'Rāmānuja',
    born: 1017, died: 1137,
    location: { lat: 12.97, lng: 79.94, city: 'Sriperumbudur', country: 'India' },
    era: 'medieval',
    tradition: 'Hindu',
    quote: 'The soul, though it attains the highest, does not lose itself in the divine.',
    concept: 'The self is real and beloved of God — liberation is loving union with the divine, not dissolution into an impersonal One.',
    ideas: ['god', 'self', 'being', 'consciousness'],
    influences: [],
    influencedBy: ['shankara'],
    color: '#FFC857'
  },
  {
    id: 'patanjali',
    name: 'Patañjali',
    born: -150, died: -100,
    location: { lat: 25.45, lng: 81.85, city: 'Prayaga', country: 'India' },
    era: 'ancient-india',
    tradition: 'Hindu',
    quote: 'Yoga is the stilling of the fluctuations of the mind.',
    concept: 'Quiet the restless movements of the mind and the seer rests, at last, in its own true nature.',
    ideas: ['self', 'consciousness', 'being'],
    influences: [],
    influencedBy: [],
    color: '#FFC857'
  },
  {
    ...
    born: 1869, died: 1948,
    location: { lat: 21.64, lng: 69.61, city: 'Porbandar', country: 'India' },
    era: 'indian-modern',
    tradition: 'Hindu',
    quote: 'Be the change that you wish to see in the world.',
    concept: 'Truth-force (satyagraha) and nonviolence (ahimsa) are the only just means to a just end — the means are the ends in the making.',
    ideas: ['freedom', 'justice', 'truth', 'good'],
    influences: [],
    influencedBy: [],
    color: '#FFC857'
  },
  {
    ...
    name: 'B. R. Ambedkar',
    born: 1891, died: 1956,
    location: { lat: 22.55, lng: 75.76, city: 'Mhow', country: 'India' },
    era: 'indian-modern',
    tradition: 'Buddhist',
    quote: 'I measure the progress of a community by the degree of progress which women have achieved.',
    concept: 'Caste is injustice built into religion itself; real liberation demands refounding society — and, for him, embracing Buddhism.',
    ideas: ['justice', 'freedom', 'power', 'self'],
    influences: [],
    influencedBy: ['buddha'],
    color: '#FFC857'
  },
  {
    ...
    born: 1895, died: 1986,
    location: { lat: 13.55, lng: 78.50, city: 'Madanapalle', country: 'India' },
    era: 'indian-modern',
    tradition: 'Hindu',
    quote: 'Truth is a pathless land.',
    concept: 'No authority, method, or belief can hand you truth; freedom is freedom from the known, not the exchange of one cage for another.',
    ideas: ['freedom', 'self', 'consciousness', 'truth'],
    influences: [],
    influencedBy: [],
    color: '#FFC857'
  },
  ...
  // ── Brazilian (additions) ───────────────────────────────────────────────────
  {
    ...
    name: 'Nísia Floresta',
    born: 1810, died: 1885,
    location: { lat: -6.05, lng: -35.21, city: 'Papari', country: 'Brazil' },
    era: 'brazil-formation',
    tradition: 'Brazilian',
    quote: 'Ignorance is the harshest slavery imposed on women.',
    concept: 'Women\'s rights are human rights; education is the ground on which emancipation is built.',
    ideas: ['freedom', 'justice', 'knowledge', 'self'],
    influences: [],
    influencedBy: [],
    color: '#00C875'
  },
  {
    ...
    name: 'Tobias Barreto',
    born: 1839, died: 1889,
    location: { lat: -10.53, lng: -37.00, city: 'Campos', country: 'Brazil' },
    era: 'brazil-formation',
    tradition: 'Brazilian',
    quote: 'Law is not a daughter of heaven — it is a product of culture.',
    concept: 'Law and morality are products of culture and history, not eternal nature — the founding insight of the Recife School.',
    ideas: ['knowledge', 'power', 'justice', 'truth'],
    influences: ['farias-brito'],
    influencedBy: [],
    color: '#00C875'
  },
  {
    ...
    name: 'Farias Brito',
    born: 1862, died: 1917,
    location: { lat: -4.04, lng: -40.86, city: 'São Benedito', country: 'Brazil' },
    era: 'brazil-formation',
    tradition: 'Brazilian',
    quote: 'The world is activity, and activity is thought.',
    concept: 'Reality is fundamentally consciousness — matter is only a passing phase in the life of spirit.',
    ideas: ['consciousness', 'being', 'self', 'god'],
    influences: [],
    influencedBy: ['tobias-barreto'],
    color: '#00C875'
  },
  {
    id: 'reale',
    name: 'Miguel Reale',
    born: 1910, died: 2006,
    location: { lat: -22.15, lng: -47.95, city: 'São Bento do Sapucaí', country: 'Brazil' },
    era: 'liberation',
    tradition: 'Brazilian',
    quote: 'Law is fact, value, and norm — indissolubly united.',
    concept: 'Every legal reality is at once a fact, a value, and a norm — his tridimensional theory of law.',
    ideas: ['justice', 'knowledge', 'being', 'truth'],
    influences: [],
    influencedBy: [],
    color: '#00C875'
  },
  {
    id: 'vieira-pinto',
    name: 'Álvaro Vieira Pinto',
    born: 1909, died: 1987,
    location: { lat: -19.75, lng: -47.93, city: 'Uberaba', country: 'Brazil' },
    era: 'liberation',
    tradition: 'Brazilian',
    quote: 'Technology is the mode by which a people takes charge of its own reality.',
    concept: 'Technology is never neutral; a nation thinks itself into existence through critical, self-aware consciousness.',
    ideas: ['consciousness', 'knowledge', 'power', 'freedom'],
    influences: [],
    influencedBy: [],
    color: '#00C875'
  },
  {
    ...
    name: 'Leonardo Boff',
    born: 1938, died: null,
    location: { lat: -27.23, lng: -52.03, city: 'Concórdia', country: 'Brazil' },
    era: 'liberation',
    tradition: 'Brazilian',
    quote: 'The cry of the earth is the cry of the poor.',
    concept: 'The oppression of the poor and the destruction of the earth are a single wound — the heart of liberation theology.',
    ideas: ['god', 'justice', 'nature', 'good', 'freedom'],
    influences: [],
    influencedBy: ['marx', 'freire'],
    color: '#00C875'
  },
  {
    id: 'chaui',
    name: 'Marilena Chaui',
    born: 1941, died: null,
    location: { lat: -23.55, lng: -46.63, city: 'São Paulo', country: 'Brazil' },
    era: 'liberation',
    tradition: 'Brazilian',
    quote: 'Ideology is a body of ideas that makes domination appear natural.',
    concept: 'Ideology makes domination look like the natural order; democracy is the ceaseless invention of new rights.',
    ideas: ['power', 'freedom', 'justice', 'knowledge'],
    influences: [],
    influencedBy: ['spinoza', 'marx'],
    color: '#00C875'
  },
  {
    id: 'abdias',
    ...
    born: 1914, died: 2011,
    location: { lat: -20.54, lng: -47.40, city: 'Franca', country: 'Brazil' },
    era: 'liberation',
    tradition: 'Afro-Brazilian',
    quote: 'The quilombo is not a thing of the past — it is a project for the future.',
    concept: 'Quilombismo: the self-governing maroon community as a living model for Black freedom and self-determination.',
    ideas: ['freedom', 'justice', 'power', 'self'],
    influences: ['lelia-gonzalez'],
    influencedBy: [],
    color: '#E0A800'
  },
  {
    ...
    name: 'Lélia Gonzalez',
    born: 1935, died: 1994,
    location: { lat: -19.92, lng: -43.94, city: 'Belo Horizonte', country: 'Brazil' },
    era: 'liberation',
    tradition: 'Afro-Brazilian',
    quote: 'We are not the ones who are marginal — we have been marginalized.',
    concept: 'Amefricanidade — race, gender, and class form a single knot, and theory must speak from the place of the racialized woman.',
    ideas: ['power', 'justice', 'language', 'self'],
    influences: ['sueli-carneiro', 'djamila-ribeiro'],
    influencedBy: ['abdias'],
    color: '#E0A800'
  },
  {
    ...
    era: 'liberation',
    tradition: 'Afro-Brazilian',
    quote: 'To be a Black woman is to resist and survive within a project of death.',
    concept: 'Epistemicídio — denying Black people the status of knowers is itself a weapon of power.',
    ideas: ['knowledge', 'power', 'justice', 'self'],
    influences: ['djamila-ribeiro'],
    influencedBy: ['lelia-gonzalez', 'foucault'],
    color: '#E0A800'
  },
  {
    id: 'djamila-ribeiro',
    ...
    born: 1980, died: null,
    location: { lat: -23.96, lng: -46.33, city: 'Santos', country: 'Brazil' },
    era: 'liberation',
    tradition: 'Afro-Brazilian',
    quote: 'To speak from one\'s own place is to break the silence imposed by power.',
    concept: 'Lugar de fala — the social place from which you speak conditions what can be said and what will be heard.',
    ideas: ['power', 'knowledge', 'language', 'justice', 'self'],
    influences: [],
    influencedBy: ['lelia-gonzalez', 'sueli-carneiro', 'de-beauvoir'],
    color: '#E0A800'
  },
  {
    id: 'krenak',
    name: 'Ailton Krenak',
    born: 1953, died: null,
    location: { lat: -18.55, lng: -41.48, city: 'Itabirinha', country: 'Brazil' },
    era: 'liberation',
    tradition: 'Indigenous',
    quote: 'We can allow ourselves to dream — and to postpone the end of the world.',
    concept: 'Humanity is not the center of, nor apart from, nature; the earth is a living body to which we belong.',
    ideas: ['nature', 'freedom', 'being', 'self'],
    influences: [],
    influencedBy: [],
    color: '#7CB342'
  },
  {
    ...
    name: 'Davi Kopenawa',
    born: 1956, died: null,
    location: { lat: 2.00, lng: -63.50, city: 'Watorikɨ', country: 'Brazil' },
    era: 'liberation',
    tradition: 'Indigenous',
    quote: 'The white people do not think far ahead. They are always too busy with the things of the moment.',
    concept: 'The forest is alive and thinking; the sky is falling because the white world has forgotten it belongs to the earth.',
    ideas: ['nature', 'being', 'consciousness'],
    influences: [],
    influencedBy: [],
    color: '#7CB342'
  }
...
export const ideas = [
  {
    ...
    philosophers: ['socrates', 'plato', 'descartes', 'kant', 'nietzsche', 'wittgenstein', 'heidegger', 'foucault', 'nagarjuna', 'laozi', 'al-ghazali', 'gandhi', 'krishnamurti', 'tobias-barreto', 'reale'],
  ...
  },
  {
    ...
    philosophers: ['spinoza', 'locke', 'rousseau', 'kant', 'hegel', 'sartre', 'camus', 'de-beauvoir', 'nietzsche', 'zhuangzi', 'berdyaev', 'freire', 'kropotkin', 'gandhi', 'ambedkar', 'krishnamurti', 'nisia-floresta', 'vieira-pinto', 'boff', 'chaui', 'abdias', 'krenak'],
  ...
  },
  {
    ...
    philosophers: ['descartes', 'hume', 'kant', 'hegel', 'husserl', 'heidegger', 'sartre', 'nagarjuna', 'avicenna', 'shankara', 'nishida', 'buddha', 'ramanuja', 'patanjali', 'krishnamurti', 'farias-brito', 'vieira-pinto', 'kopenawa'],
  ...
  },
  {
    ...
    philosophers: ['descartes', 'spinoza', 'aquinas', 'averroes', 'kierkegaard', 'nietzsche', 'al-ghazali', 'shankara', 'solovyov', 'berdyaev', 'ramanuja', 'farias-brito', 'boff'],
  ...
  },
  {
    ...
    philosophers: ['socrates', 'hume', 'kant', 'kierkegaard', 'nietzsche', 'sartre', 'heidegger', 'zhuangzi', 'nagarjuna', 'wittgenstein', 'dogen', 'nishida', 'avicenna', 'shankara', 'buddha', 'xunzi', 'hanfeizi', 'wang-yangming', 'ramanuja', 'patanjali', 'ambedkar', 'krishnamurti', 'nisia-floresta', 'farias-brito', 'abdias', 'lelia-gonzalez', 'sueli-carneiro', 'djamila-ribeiro', 'krenak'],
  ...
  },
  {
    ...
    philosophers: ['plato', 'aristotle', 'hegel', 'heidegger', 'sartre', 'nagarjuna', 'laozi', 'shankara', 'dogen', 'nishida', 'spinoza', 'solovyov', 'berdyaev', 'buddha', 'ramanuja', 'patanjali', 'farias-brito', 'reale', 'krenak', 'kopenawa'],
  ...
  },
  {
    ...
    philosophers: ['nietzsche', 'marx', 'foucault', 'freire', 'unger', 'kropotkin', 'hanfeizi', 'ambedkar', 'tobias-barreto', 'vieira-pinto', 'chaui', 'abdias', 'lelia-gonzalez', 'sueli-carneiro', 'djamila-ribeiro'],
  ...
  },
  {
    ...
    philosophers: ['socrates', 'plato', 'aristotle', 'descartes', 'locke', 'hume', 'kant', 'wittgenstein', 'foucault', 'freire', 'xunzi', 'wang-yangming', 'nisia-floresta', 'tobias-barreto', 'reale', 'vieira-pinto', 'chaui', 'sueli-carneiro', 'djamila-ribeiro'],
  ...
  },
  {
    ...
    philosophers: ['plato', 'aristotle', 'rousseau', 'locke', 'marx', 'de-beauvoir', 'freire', 'unger', 'kropotkin', 'mozi', 'hanfeizi', 'gandhi', 'ambedkar', 'nisia-floresta', 'tobias-barreto', 'reale', 'boff', 'chaui', 'abdias', 'lelia-gonzalez', 'sueli-carneiro', 'djamila-ribeiro'],
  ...
  },
  {
    ...
    philosophers: ['wittgenstein', 'heidegger', 'foucault', 'laozi', 'freire', 'lelia-gonzalez', 'djamila-ribeiro'],
  ...
  },
  {
    ...
    philosophers: ['socrates', 'plato', 'aristotle', 'aquinas', 'kant', 'nietzsche', 'sartre', 'confucius', 'mencius', 'zhu-xi', 'spinoza', 'solovyov', 'kropotkin', 'buddha', 'mozi', 'xunzi', 'wang-yangming', 'gandhi', 'boff'],
  ...
  },
  {
    ...
    philosophers: ['socrates', 'plato', 'aristotle', 'confucius', 'mencius', 'zhu-xi', 'mozi', 'xunzi', 'wang-yangming'],
  ...
  },
  {
    ...
    icon: '❋',
    color: '#7CB342',
    description: 'Is the earth a resource to be used, or a living web we belong to?',
    centralQuestion: 'Are we owners of nature, or one of its relatives?',
    philosophers: ['laozi', 'zhuangzi', 'spinoza', 'kropotkin', 'boff', 'krenak', 'kopenawa'],
    relatedIdeas: ['being', 'freedom', 'good'],
    tension: ['power']
  }
]
...
export const eras = [
  ...
  },
  {
    ...
    description: 'While Socrates questioned Athenians, Confucius reformed Chinese courts, Laozi vanished into paradox, Mozi preached impartial love, and Xunzi and Han Feizi wrestled over whether people are made good by ritual or ruled by law. The East did not separate philosophy from practice.',
    philosophers: ['confucius', 'laozi', 'zhuangzi', 'mencius', 'mozi', 'xunzi', 'hanfeizi'],
  ...
  },
  {
    ...
    description: 'Beneath the Bodhi tree, the Buddha taught that the self we defend is a fiction and craving the root of suffering. Patañjali mapped the stilling of the mind; Nāgārjuna\'s Madhyamaka showed that even emptiness is empty. The project was not despair but liberation.',
    philosophers: ['buddha', 'patanjali', 'nagarjuna'],
  ...
  },
  {
    ...
    description: 'Medieval philosophy was not stagnation but translation: Arabic scholars preserved and transformed Greek thought, scholastics fused it with theology, and in India Rāmānuja answered Śaṅkara with a God who loves — creating cathedral-like systems of total explanation.',
    philosophers: ['averroes', 'aquinas', 'ramanuja'],
  ...
  },
  {
    ...
    description: 'Foucault showed how power flows through knowledge; the postmodern project revealed that every structure of "truth" conceals an act of domination.',
  ...
  {
    id: 'neo-confucian',
    name: 'The Confucian Renaissance',
    range: [1000, 1650],
    label: '1000–1650',
    color: '#FF8C42',
    paradigmShift: 'Principle, mind, and the unity of knowing and acting.',
    description: 'Long after the classical masters, China\'s thinkers rebuilt Confucianism into a full metaphysics. Zhu Xi taught that every thing holds an inner principle (li) to be investigated; Wang Yangming answered that principle lives in the mind itself, and that to truly know the good is already to do it.',
    philosophers: ['zhu-xi', 'wang-yangming'],
    keyIdea: 'Is moral knowledge found in the world or in the mind?',
    visual: 'ink'
  },
  {
    id: 'indian-modern',
    name: 'The Indian Awakening',
    range: [1820, 1965],
    label: '1820–1965',
    color: '#FFC857',
    paradigmShift: 'Ancient wisdom meets colonialism, caste, and the struggle for freedom.',
    description: 'Under empire, Indian thought turned to action. Gandhi forged nonviolence into a political force; Ambedkar exposed caste as injustice woven into religion and led millions toward Buddhism; Krishnamurti dissolved every authority, calling truth a pathless land.',
    philosophers: ['gandhi', 'ambedkar', 'krishnamurti'],
    keyIdea: 'Can the spirit liberate the body politic?',
    visual: 'light'
  },
  {
    id: 'brazil-formation',
    name: 'The Brazilian Awakening',
    range: [1830, 1930],
    label: '1830–1930',
    color: '#00C875',
    paradigmShift: 'A young nation begins to think in its own voice.',
    description: 'As Brazil left empire behind, its first original thinkers emerged: Nísia Floresta demanding the education and rights of women, Tobias Barreto and the Recife School reading law and morality as products of culture, and Farias Brito building the country\'s first systematic metaphysics of consciousness.',
    philosophers: ['nisia-floresta', 'tobias-barreto', 'farias-brito'],
    keyIdea: 'What does it mean to philosophize from the periphery?',
    visual: 'light'
  },
  {
    id: 'liberation',
    name: 'Liberation & Decolonization',
    range: [1930, 2025],
    label: '1930–present',
    color: '#00C875',
    paradigmShift: 'Philosophy from the margins — of the poor, the colonized, the Black, the Indigenous.',
    description: 'A wave of thinkers rewrote philosophy from the underside of history. Freire and Boff made pedagogy and theology into liberation; Reale, Chaui and Vieira Pinto built rigorous systems; Abdias, Lélia Gonzalez, Sueli Carneiro and Djamila Ribeiro theorized race, gender and the right to speak; Krenak and Kopenawa spoke for a living earth.',
    philosophers: ['freire', 'unger', 'reale', 'vieira-pinto', 'boff', 'chaui', 'abdias', 'lelia-gonzalez', 'sueli-carneiro', 'djamila-ribeiro', 'krenak', 'kopenawa'],
    keyIdea: 'Whose knowledge counts, and who gets to speak?',
    visual: 'network'
  }
]
...
export const dailyQuestions = [
  ...
  {
    question: 'If the earth is not a resource but a relative — how would you have to live differently?',
    subtext: 'Krenak asks us to imagine ideas that might postpone the end of the world.',
    philosopher: 'krenak',
    idea: 'nature'
  },
  {
    question: 'Whose voice does your society treat as knowledge — and whose does it treat as mere opinion?',
    subtext: 'Sueli Carneiro calls the silencing of the oppressed a kind of epistemic murder.',
